...
-- eiksy.henhouse definition

CREATE TABLE `henhouse` (
  `id` bigint(20) DEFAULT NULL COMMENT '序号',
  `name` varchar(100) DEFAULT NULL COMMENT '鸡舍名称',
...
-- eiksy.humidity definition

CREATE TABLE `humidity` (
  `id` bigint(20) DEFAULT NULL,
  `time` varchar(100) DEFAULT NULL,
  `shidu` varchar(100) DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  `type` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;


-- eiksy.sensor definition

CREATE TABLE `sensor` (
  `id` bigint(20) DEFAULT NULL,
  `type` varchar(100) DEFAULT NULL,
  `hen_id` bigint(20) DEFAULT NULL,
  `weizhi` varchar(100) DEFAULT NULL COMMENT '安装位置',
  `create_time` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;


-- eiksy.thermal definition

CREATE TABLE `thermal` (
  `id` bigint(20) DEFAULT NULL,
  `time` datetime DEFAULT NULL,
  `wendu` varchar(200) DEFAULT NULL,
...
INSERT INTO sys_menu (id,pid,name,url,permissions,menu_type,icon,sort,creator,create_date,updater,update_date) VALUES
	 (1067246875800000003,1067246875800000055,'新增',NULL,'sys:user:save,sys:dept:list,sys:role:list',1,NULL,1,1067246875800000001,'2024-06-09 22:16:41',1067246875800000001,'2024-06-09 22:16:41'),
	 (1067246875800000004,1067246875800000055,'修改',NULL,'sys:user:update,sys:dept:list,sys:role:list',1,NULL,2,1067246875800000001,'2024-06-09 22:16:41',1067246875800000001,'2024-06-09 22:16:41'),
	 (1067246875800000005,1067246875800000055,'删除',NULL,'sys:user:delete',1,NULL,3,1067246875800000001,'2024-06-09 22:16:41',1067246875800000001,'2024-06-09 22:16:41'),
	 (1067246875800000006,1067246875800000055,'导出',NULL,'sys:user:export',1,NULL,4,1067246875800000001,'2024-06-09 22:16:41',1067246875800000001,'2024-06-09 22:16:41'),
	 (1067246875800000007,1806682937504624641,'角色管理','sys/role',NULL,0,'icon-team',2,1067246875800000001,'2024-06-09 22:16:41',1067246875800000001,'2024-06-28 21:37:21'),
	 (1067246875800000008,1067246875800000007,'查看',NULL,'sys:role:page,sys:role:info',1,NULL,0,1067246875800000001,'2024-06-09 22:16:41',1067246875800000001,'2024-06-09 22:16:41'),
	 (1067246875800000009,1067246875800000007,'新增',NULL,'sys:role:save,sys:menu:select,sys:dept:list',1,NULL,1,1067246875800000001,'2024-06-09 22:16:41',1067246875800000001,'2024-06-09 22:16:41'),
	 (1067246875800000010,1067246875800000007,'修改',NULL,'sys:role:update,sys:menu:select,sys:dept:list',1,NULL,2,1067246875800000001,'2024-06-09 22:16:41',1067246875800000001,'2024-06-09 22:16:41'),
	 (1067246875800000011,1067246875800000007,'删除',NULL,'sys:role:delete',1,NULL,3,1067246875800000001,'2024-06-09 22:16:41',1067246875800000001,'2024-06-09 22:16:41'),
	 (1067246875800000012,1806682937504624641,'公司管理','sys/dept',NULL,0,'icon-apartment',1,1067246875800000001,'2024-06-09 22:16:41',1067246875800000001,'2024-06-28 21:36:55');
INSERT INTO sys_menu (id,pid,name,url,permissions,menu_type,icon,sort,creator,create_date,updater,update_date) VALUES
	 (1067246875800000014,1067246875800000012,'查看',NULL,'sys:dept:list,sys:dept:info',1,NULL,0,1067246875800000001,'2024-06-09 22:16:41',1067246875800000001,'2024-06-09 22:16:41'),
	 (1067246875800000015,1067246875800000012,'新增',NULL,'sys:dept:save',1,NULL,1,1067246875800000001,'2024-06-09 22:16:41',1067246875800000001,'2024-06-09 22:16:41'),
	 (1067246875800000016,1067246875800000012,'修改',NULL,'sys:dept:update',1,NULL,2,1067246875800000001,'2024-06-09 22:16:41',1067246875800000001,'2024-06-09 22:16:41'),
	 (1067246875800000017,1067246875800000012,'删除',NULL,'sys:dept:delete',1,NULL,3,1067246875800000001,'2024-06-09 22:16:41',1067246875800000001,'2024-06-09 22:16:41'),
	 (1067246875800000025,1067246875800000035,'菜单管理','sys/menu',NULL,0,'icon-unorderedlist',0,1067246875800000001,'2024-06-09 22:16:41',1067246875800000001,'2024-06-09 22:16:41'),
	 (1067246875800000026,1067246875800000025,'查看',NULL,'sys:menu:list,sys:menu:info',1,NULL,0,1067246875800000001,'2024-06-09 22:16:41',1067246875800000001,'2024-06-09 22:16:41'),
	 (1067246875800000027,1067246875800000025,'新增',NULL,'sys:menu:save',1,NULL,1,1067246875800000001,'2024-06-09 22:16:41',1067246875800000001,'2024-06-09 22:16:41'),
	 (1067246875800000028,1067246875800000025,'修改',NULL,'sys:menu:update',1,NULL,2,1067246875800000001,'2024-06-09 22:16:41',1067246875800000001,'2024-06-09 22:16:41'),
	 (1067246875800000029,1067246875800000025,'删除',NULL,'sys:menu:delete',1,NULL,3,1067246875800000001,'2024-06-09 22:16:41',1067246875800000001,'2024-06-09 22:16:41'),
	 (1067246875800000035,0,'系统设置',NULL,NULL,0,'icon-setting',0,1067246875800000001,'2024-06-09 22:16:41',1067246875800000001,'2024-06-28 21:37:48');
INSERT INTO sys_menu (id,pid,name,url,permissions,menu_type,icon,sort,creator,create_date,updater,update_date) VALUES
	 (1067246875800000055,1806682937504624641,'用户管理','sys/user',NULL,0,'icon-user',0,1067246875800000001,'2024-06-09 22:16:41',1067246875800000001,'2024-06-28 21:36:12'),
	 (1067246875800000056,1067246875800000055,'查看',NULL,'sys:user:page,sys:user:info',1,NULL,0,1067246875800000001,'2024-06-09 22:16:41',1067246875800000001,'2024-06-09 22:16:41'),
	 (1806682937504624641,0,'权限管理','','',0,'',1,1067246875800000001,'2024-06-28 21:35:54',1067246875800000001,'2024-06-28 21:37:58'),
	 (1806925559952916481,0,'社团管理','mass/mass','demo:mass:page,demo:mass:save,demo:mass:update,demo:mass:info,demo:mass:delete',0,'icon-plus-square-fill',2,1067246875800000001,'2024-06-29 13:39:59',1067246875800000001,'2024-07-07 21:29:41'),
	 (1806925875641401345,0,'社团申请管理','mass/massuser','demo:massuser:page,demo:massuser:save,demo:massuser:update,demo:massuser:info,demo:massuser:delete',0,'icon-right-square-fill',3,1067246875800000001,'2024-06-29 13:41:14',1067246875800000001,'2024-07-07 21:31:07');
