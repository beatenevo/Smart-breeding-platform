<template>
  <div class="rr-login">
    <h1 class="rr-login-left-title" style="font-size:50px;" >智慧养殖平台</h1>
...
.rr-login-left .hidden-sm-and-down{
  background-image: url("@/assets/images/kun.jpg");
}
.rr-login {
  width: 100vw;
  height: 100vh;
