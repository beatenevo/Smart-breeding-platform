...
const dataForm = reactive({
  id: '',  enterpriseid: '',  enterprisename: '',  name: '',  type: '',  available: '',  telephone: '',  salary: '',  worktime: ''});
...
const dataFormSubmitHandle = () => {
  dataFormRef.value.validate((valid: boolean) => {
    ...
    (!dataForm.id ? baseService.post : baseService.put)("/demo/company", dataForm).then((res) => {
      ElMessage.success({
        message: '成功',
        duration: 500,
        onClose: () => {
