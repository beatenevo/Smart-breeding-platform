...
const dataForm = reactive({
  id: '',  name: '',  introduction: '',  adminid: '',  adminname: ''});
...
const getInfo = (id: number) => {
  baseService.get("/demo/enterprise/" + id).then((res) => {
...
const dataFormSubmitHandle = () => {
  dataFormRef.value.validate((valid: boolean) => {
    ...
    (!dataForm.id ? baseService.post : baseService.put)("/demo/enterprise", dataForm).then((res) => {
      ElMessage.success({
        message: '成功',
        duration: 500,
        onClose: () => {
